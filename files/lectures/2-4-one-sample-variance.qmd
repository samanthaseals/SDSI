...
- Then, we will perform a hypothesis test to answer the question.    
    ...
    - Is the standard deviation of recruit side-hustle earnings different from $1,200?
    
- How do we translate this into hypotheses?  

    - $H_0: \sigma^2 = 1,440,000$ -- note that they gave us $\sigma$, not $\sigma^2$ 
    - $H_1: \sigma^2 \ne 1,440,000$
...
- **Conclusion and Interpretation**
    ...
    - Reject $H_0$. There is sufficient evidence to suggest that the current standard deviation is different from $1200.
